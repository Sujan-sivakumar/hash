...
def insert_into_snowflake(df):
    ...
    try:
        ...
        for index, row in df.iterrows():
            # Convert skills list to JSON string (VARIANT format)
            ...
            cur.execute(insert_query, (
                ...
                dob_value,
                row['College'],
                skills_json  # Use JSON string here for VARIANT data type
            ))
...
# Main function
def main():
    pdf_file_path = 'Resume 2.pdf'  # Path to your PDF file
