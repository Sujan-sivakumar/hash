...
#             # Ensure all key columns are present and in the correct order
#             df_key_columns = df[key_columns].copy()  # Select only key columns
...
try:
    while current_start_number < total_records_to_fetch:
        ...
        if response.status_code == 200:
            ...
            print("DataFrame content before writing to Parquet:")
            print(df_key_columns.head())
...
loaded_df = loaded_table.to_pandas(z)
print("Loaded DataFrame from Parquet file:")
